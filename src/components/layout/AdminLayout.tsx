...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex min-h-screen bg-muted text-foreground dark:bg-slate-900 dark:text-slate-100">
      {/* Sidebar */}
      <aside
      ...
      >
        <div className="p-6 border-b border-border dark:border-slate-700 flex items-center justify-between md:justify-start">
      ...
      <button
        className="md:hidden fixed top-4 left-4 z-40 p-2 bg-white dark:bg-slate-800 border border-border rounded-md shadow"
      ...
      <div className="flex-1 md:ml-64 w-full">
        {/* Top Nav */}
        <header className="bg-white dark:bg-slate-800 px-6 py-4 shadow border-b border-border dark:border-slate-700 flex items-center justify-between">
